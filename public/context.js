          ...
          <div className="card-body">
              ...
              {props.handle && show ? (
                 ...
                 <center><button type="submit" 
                    ...
                    onClick={handleCreate} >Create Account</button></center>
                 </>
              ) : (
              props.submitButton && (
                 <>
                  ...
                  <Link to="/account">
                    <button type="submit" className="btn btn-outline-light">{props.submitButton}</button>
                  </Link>
                 </>
              )
              )}
              ...
              {props.deposit && show ? (
                ...
                <center><button type="submit" className="btn btn-outline-light" onClick={handleTransaction} >Deposit</button></center>
                </>
              ) : (props.submitButtonDeposit && (
                  <>
                  <div className="card text-white text-center bg-success mb-3">
                    <h5>Successful Deposit</h5><br/>
                    Current User Account:
                    {user.name}<br/>
                    Balance after deposit: {user.balance}<br/>
                  </div>
                  <center><button type="submit" className="btn btn-outline-light" onClick={clearForm}>Make another Transaction</button></center>
                  </>
                )
              )}
              ...
              {props.withdraw && show ? (
                ...
                <center><button type="submit" className="btn btn-outline-light" onClick={handleTransaction} >Withdrawl</button></center>
                </>
              ...
              {props.login && show ? (
                <>
                <center>{!user.name ? "Please Login " : `Current Logged In User: ${user.name}`}</center><br/>
                Confirm Account Email<br/>
                ...
                <center><button type="submit" disabled={!validatePassword()} className="btn btn-outline-light" onClick={handleLogin} >Submit for verification</button></center>
                </>
                ...
                <Link to="/account">
                  <center><button type="submit" className="btn btn-outline-light">Continue to Account</button></center>
                </Link>
                </>
                )
              )}
